...
public class ChangesAssertionExamples extends AbstractAssertionsExamples {
  ...
  public void column_type_assertion_examples() throws SQLException {
    ...
    assertThat(changes)
        .change()
            .column().isNumber(true).isOfType(ValueType.NUMBER, true).isOfAnyOfTypes(ValueType.NUMBER, ValueType.NOT_IDENTIFIED)
        ...
        .change()
            .column().isNumber(true).isOfType(ValueType.NUMBER, true).isOfAnyOfTypes(ValueType.NUMBER, ValueType.NOT_IDENTIFIED)
            .column().isDate(true).isOfType(ValueType.DATE, true).isOfAnyOfTypes(ValueType.DATE, ValueType.NOT_IDENTIFIED)
            .column().isText(true).isOfType(ValueType.TEXT, true).isOfAnyOfTypes(ValueType.TEXT, ValueType.NOT_IDENTIFIED)
            .column().isNumber(true).isOfType(ValueType.NUMBER, true).isOfAnyOfTypes(ValueType.NUMBER, ValueType.NOT_IDENTIFIED)
            .column().isTime(true).isOfType(ValueType.TIME, true).isOfAnyOfTypes(ValueType.TIME, ValueType.NOT_IDENTIFIED);
  }
  ...
  public void value_type_assertion_examples() throws SQLException {
    ...
    assertThat(changes)
        .change()
            .rowAtEndPoint()
                .value().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER, ValueType.BOOLEAN)
                .value().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT, ValueType.BOOLEAN)
                .value().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT, ValueType.BOOLEAN)
                .value()
                .value().isDate().isOfType(ValueType.DATE).isOfAnyOfTypes(ValueType.DATE, ValueType.BOOLEAN)
            .column()
                .valueAtEndPoint().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER, ValueType.BOOLEAN)
            .column()
                .valueAtEndPoint().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT, ValueType.BOOLEAN)
            .column()
                .valueAtEndPoint().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT, ValueType.BOOLEAN)
            .column()
            .column()
                .valueAtEndPoint().isDate().isOfType(ValueType.DATE).isOfAnyOfTypes(ValueType.DATE, ValueType.BOOLEAN)
        .change()
            .rowAtStartPoint()
                .value().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER, ValueType.BOOLEAN)
                .value().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT, ValueType.BOOLEAN)
            ...
            .rowAtEndPoint()
                ...
                .value().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER, ValueType.BOOLEAN)
            .column()
                .valueAtStartPoint().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER, ValueType.BOOLEAN)
                .valueAtEndPoint().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER, ValueType.BOOLEAN)
            .column()
                .valueAtStartPoint().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT, ValueType.BOOLEAN)
                .valueAtEndPoint().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT, ValueType.BOOLEAN)
            .column()
                .valueAtStartPoint().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT, ValueType.BOOLEAN)
                .valueAtEndPoint().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT, ValueType.BOOLEAN)
            .column()
                ...
                .valueAtEndPoint().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT, ValueType.BOOLEAN)
            .column()
                .valueAtStartPoint().isDate().isOfType(ValueType.DATE).isOfAnyOfTypes(ValueType.DATE, ValueType.BOOLEAN)
                .valueAtEndPoint().isDate().isOfType(ValueType.DATE).isOfAnyOfTypes(ValueType.DATE, ValueType.BOOLEAN)
            .column()
                .valueAtStartPoint().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER, ValueType.BOOLEAN)
                .valueAtEndPoint().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER, ValueType.BOOLEAN)
        .change()
            .rowAtStartPoint()
                ...
                .value().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT, ValueType.BOOLEAN)
                .value().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER, ValueType.BOOLEAN)
                .value().isTime().isOfType(ValueType.TIME).isOfAnyOfTypes(ValueType.TIME, ValueType.BOOLEAN)
            .column()
                .valueAtStartPoint().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER, ValueType.BOOLEAN)
            .column()
                .valueAtStartPoint().isDate().isOfType(ValueType.DATE).isOfAnyOfTypes(ValueType.DATE, ValueType.BOOLEAN)
            ...
            .column()
                .valueAtStartPoint().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER, ValueType.BOOLEAN)
            .column()
                .valueAtStartPoint().isTime().isOfType(ValueType.TIME).isOfAnyOfTypes(ValueType.TIME, ValueType.BOOLEAN);
  }
