...
public class TableAssertionExamples extends AbstractAssertionsExamples {
  ...
  public void value_type_assertion_examples() {
    ...
    assertThat(table)
        .column()
            .value().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER)
            .value().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER)
            .value().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER)
            .value().isNumber().isOfType(ValueType.NUMBER).isOfAnyOfTypes(ValueType.NUMBER)
        .column()
            .value().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT)
            .value().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT)
            .value().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT)
            .value().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT)
        .column()
        ...
        .column()
            .value().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT)
            .value().isText().isOfType(ValueType.TEXT).isOfAnyOfTypes(ValueType.TEXT)
            .value().isOfType(ValueType.NOT_IDENTIFIED).isOfAnyOfTypes(ValueType.NOT_IDENTIFIED)
            .value().isOfType(ValueType.NOT_IDENTIFIED).isOfAnyOfTypes(ValueType.NOT_IDENTIFIED)
        .column()
            .value().isDate().isOfType(ValueType.DATE).isOfAnyOfTypes(ValueType.DATE)
            .value().isDate().isOfType(ValueType.DATE).isOfAnyOfTypes(ValueType.DATE)
            .value().isDate().isOfType(ValueType.DATE).isOfAnyOfTypes(ValueType.DATE)
            .value().isDate().isOfType(ValueType.DATE).isOfAnyOfTypes(ValueType.DATE)
        .column()
