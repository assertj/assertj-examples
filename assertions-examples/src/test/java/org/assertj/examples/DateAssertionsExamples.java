...
public class DateAssertionsExamples extends AbstractAssertionsExamples {
	...
	public void basic_date_assertions_examples() {
		...
		assertThat(this.theTwoTowers.getReleaseDate()).isEqualTo(parse("2002-12-18")).isEqualTo("2002-12-18")
				.isAfter(this.theFellowshipOfTheRing.getReleaseDate())
				.isBefore(this.theReturnOfTheKing.getReleaseDate())
				.isNotEqualTo(parse("2002-12-19")).isNotEqualTo("2002-12-19");

		assertThat(this.theTwoTowers.getReleaseDate()).isEqualTo(parse("2002-12-18")).isAfter("2002-12-17")
				.isBefore("2002-12-19");

		assertThat(this.theReturnOfTheKing.getReleaseDate()).isBeforeYear(2004).isAfterYear(2001);

		// isIn isNotIn works with String based date parameter
		assertThat(this.theTwoTowers.getReleaseDate()).isIn("2002-12-17", "2002-12-18", "2002-12-19");
		assertThat(this.theTwoTowers.getReleaseDate()).isNotIn("2002-12-17", "2002-12-19");
	...
	public void is_between_date_assertions_examples() {
		...
		assertThat(this.theTwoTowers.getReleaseDate()).isBetween(this.theFellowshipOfTheRing.getReleaseDate(),
				this.theReturnOfTheKing.getReleaseDate())
	...
	public void date_assertions_comparison_with_precision_level() {
		...
		final Date date1 = parseDatetimeWithMs("2003-01-01T01:00:00.000");
		final Date date2 = parseDatetimeWithMs("2003-01-01T01:00:00.555");
		final Date date3 = parseDatetimeWithMs("2003-01-01T01:00:55.555");
		final Date date4 = parseDatetimeWithMs("2003-01-01T01:55:55.555");
		final Date date5 = parseDatetimeWithMs("2003-01-01T05:55:55.555");
	...
	public void is_today_in_the_future_or_in_the_past_assertions_examples() {
		...
		assertThat(this.theTwoTowers.getReleaseDate()).isInThePast();
		assertThat(new Date()).isToday();
		assertThat(this.theSilmarillion.getReleaseDate()).isInTheFuture();
	}
	...
	public void is_in_the_same_second_assertions_examples() {
		...
		final Date date1 = parseDatetimeWithMs("2003-01-01T12:00:01.000");
		final Date date2 = parseDatetimeWithMs("2003-01-01T12:00:01.250");
		final Date date3 = parseDatetimeWithMs("2003-01-01T12:00:00.999");
	...
	public void is_in_the_same_minute_assertions_examples() {
		// let's see the isInSameSecondAs and isInSameSecondWindowAs in action and their difference
		final Date date1 = parseDatetime("2003-01-01T12:01:00");
		final Date date2 = parseDatetime("2003-01-01T12:01:30");
		final Date date3 = parseDatetime("2003-01-01T12:00:59");
	...
	public void is_in_the_same_hour_assertions_examples() {
		// let's see the isInSameSecondAs and isInSameSecondWindowAs in action and their difference
		final Date date1 = parseDatetime("2003-01-01T12:00:00");
		final Date date2 = parseDatetime("2003-01-01T12:30:00");
		final Date date3 = parseDatetime("2003-01-01T11:59:59");
		final Date date4 = parseDatetime("2003-01-01T13:00:01");
	...
	public void is_in_the_same_day_or_month_or_year_assertions_examples() {
		final Date date1 = parseDatetime("2003-04-26T23:17:00");
		final Date date2 = parseDatetime("2003-04-26T12:30:00");
	...
	public void has_field_date_assertions_examples() {
		final Date date1 = parseDatetimeWithMs("2003-04-26T13:20:35.017");
	...
	public void date_assertions_with_date_represented_as_string() {
		...
		assertThat(this.theTwoTowers.getReleaseDate()).isEqualTo("2002-12-18");
		assertThat(this.theTwoTowers.getReleaseDate()).isEqualTo("2002-12-18T00.00.00");
		assertThat(this.theTwoTowers.getReleaseDate()).isEqualTo("2002-12-18T00.00.00.000");

		// but you can use custom date format if you prefer
		final DateFormat userCustomDateFormat = new SimpleDateFormat("dd/MM/yyyy");
		assertThat(this.theTwoTowers.getReleaseDate()).withDateFormat(userCustomDateFormat).isEqualTo("18/12/2002");
		// once set, custom format is used for all following assertions !
		assertThat(this.theReturnOfTheKing.getReleaseDate()).isEqualTo("17/12/2003");

		// you can easily get back to default date formats ...
		assertThat(this.theTwoTowers.getReleaseDate()).withDefaultDateFormatsOnly().isEqualTo("2002-12-18");
		// ... which is then used for all following assertions
		assertThat(this.theReturnOfTheKing.getReleaseDate()).isEqualTo("2003-12-17");
		...
		assertThat(this.theTwoTowers.getReleaseDate()).isEqualTo("18/12/2002");
		assertThat(this.theReturnOfTheKing.getReleaseDate()).isEqualTo("17/12/2003");
	...
	public void date_assertions_with_custom_comparison_examples() {
		...
		assertThat(this.theTwoTowers.getReleaseDate()).usingComparator(this.yearAndMonthComparator).isEqualTo("2002-12-01")
		...
		final Date oneDayFromTodayInSameMonth = monthOf(tomorrow()) == monthOf(new Date()) ? tomorrow() : yesterday();
		assertThat(oneDayFromTodayInSameMonth).usingComparator(this.yearAndMonthComparator).isToday();
	}
